...
6. **参考来源**（汇总子Agent所有引用，见下方格式说明）

## 引用规范

- **正文内联标记**：凡引用某条新闻/网页，在该句末用 `[N]` 标注编号
- **末尾汇总引用**：将所有子Agent报告中的参考来源收集起来，统一在最终报告末尾输出：
  ```
  ## 参考来源

  ### 新闻 & 网页
  [1] [来源名称 — 标题](url) — 日期（[DB]或[Web]）
  [2] [来源名称 — 标题](url) — 日期（[DB]或[Web]）

  ### 引用论文
  [P1] 《论文标题》 — 第一作者等, 期刊/会议, 发表日期
  [P2] 《论文标题》 — 第一作者等, 期刊/会议, 发表日期
  （论文暂无直接链接，建议在 Google Scholar / Semantic Scholar 搜索标题）
  ```
- **不要丢失任何子Agent提供的 source_url / url**，全部收入"参考来源"
- **编号连续**：新闻/网页用 [1][2]...，论文用 [P1][P2]... 分类编号
