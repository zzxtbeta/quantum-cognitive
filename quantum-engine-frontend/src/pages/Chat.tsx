...
export default function Chat() {
  const { messages, loading, error, threadId, activeSubagent, toolSteps, savedThreads, sendMessage, clearMessages, cancelGeneration, switchThread, deleteThread } = useChat();
            ...
            {savedThreads.length === 0 ? (
              ...
              savedThreads.map((meta: ThreadMeta) => (
                ...
                >
                  ...
                  >
                    <span className="text-[8.5px] font-bold px-1.5 py-0.5 rounded mt-0.5 shrink-0 bg-violet-500/15 text-violet-400">
                      DEEP
                    </span>
